...
config = {
    ...
    'save_path': './models/maml.ckpt',  # Your model will be saved here.
    'k_shot': 20,
}
...
model = Net().to(device) 
checkpoint = torch.load('C:/Users/gary/Desktop/面試程式/few-shot regression/pretrain/1000.pth', map_location=device)
...
model.load_state_dict(torch.load(config['save_path']))   # zero gradient need 註解掉
